            ...
            <div className="mb-16 flex flex-col md:flex-row gap-[2rem]">
                <div className="flex gap-[2rem]">
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/cattle" target="_blank">Cattle</a></h3>
                    </div>
                    <div>
                        <img src={duck} alt="two white ducks in a petting zoo" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/ducks" target="_blank">Ducks</a></h3>
                    </div>
                </div>
                ...
                <div className="flex gap-[2rem]">
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/alpacas/alpacas" target="_blank">Alpacas</a></h3>
                    </div>
                    <div>
                        <img src={pig} alt="black and white pig on a farm" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/pigs" target="_blank">Pigs</a></h3>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row bg-blue-dark">
                <div className="py-4 px-8 flex-[1_1_clamp(30%,50%,70%)] flex flex-col md:min-h-[400px] justify-center text-center text-white">
                    <div>
                        ...
                        <a href="https://sites.google.com/view/blueshamrockfarm/kerry-bog-pony" target="_blank">More Info<span className="sr-only"> on kerry bog ponies</span></a>
                    </div>
                </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row gap-[2rem]">
                <div className="flex gap-[2rem]">
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/rabbits" target="_blank">Rabbits</a></h3>
                    </div>
                    <div>
                        <img src={peacock} alt="colorful peacock with feathers spread" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/peafowl" target="_blank">Peafowl</a></h3>
                    </div>
                </div>
                ...
                <div className="flex gap-[2rem]">
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/donkeys" target="_blank">Donkeys</a></h3>
                    </div>
                    <div>
                        <img src={chicken} alt="closeup of red chickens" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/chickens" target="_blank">Chickens</a></h3>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row gap-[2rem]">
                <div className="flex gap-[2rem]">
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/horses" target="_blank">Horses</a></h3>
                    </div>
                    <div>
                        <img src={budgie} alt="colorful bird sitting on woman's hand" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/quail" target="_blank">Budgies</a></h3>
                    </div>
                </div>
                ...
                <div className="flex gap-[2rem]">
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/guinea-pigs" target="_blank">Guinea Pigs</a></h3>
                    </div>
                    <div>
                        <img src={geese} alt="two geese in front of a pond" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/geese" target="_blank">Geese</a></h3>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row bg-blue-dark">
                <div className="py-4 px-8 flex-[1_1_clamp(30%,50%,70%)] flex flex-col md:min-h-[400px] justify-center text-center text-white ">
                    <div>
                        ...
                        <a href="https://sites.google.com/view/blueshamrockfarm/nigerian-dwarf-goats" target="_blank">More Info<span className="sr-only"> on nigerian dwarf goats</span></a>
                    </div>
                </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row gap-[2rem]">
                <div className="flex gap-[2rem]">
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/llamas" target="_blank">Llamas</a></h3>
                    </div>
                    <div>
                        <img src={chinchilla} alt="charcoal chinchilla sitting on a table" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/chinchillas" target="_blank">Chinchillas</a></h3>
                    </div>
                </div>
                ...
                <div className="flex gap-[2rem]">
                    ...
                    <div>
                        ...
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/rats" target="_blank">Rats</a></h3>
                    </div>
                    <div>
                        <img src={cat} alt="cat looking down at the camera from a fence" />
                        <h3 className="animal-tag"><a href="https://sites.google.com/view/blueshamrockfarm/cats" target="_blank">Cats</a></h3>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row bg-blue-dark">
                <div className="py-4 px-8 flex-[1_1_clamp(30%,50%,70%)] flex flex-col md:min-h-[400px] justify-center text-center text-white ">
                    <div>
                        ...
                        <a href="https://sites.google.com/view/blueshamrockfarm/sheep" target="_blank">More Info<span className="sr-only"> on shetland sheep</span></a>
                    </div>
                </div>
