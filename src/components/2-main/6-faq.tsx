    ...
    return (
        <>
            ...
            <section className="max-content">
                ...
                <p className="mb-6">For the safety of all animals, outside animals are not permitted to interact with our animals. Please ensure dogs, etc are contained and no outside animals "boop snoots".</p>
            </section>
