        ...
        <footer className='bg-blue-dark text-white p-4'>
            <div className="max-content my-6 flex justify-between items-center">
                    ...
                    <div>
                        <div className="flex">
                            <a target="_blank" rel="noopener noreferrer"
                                href="https://www.facebook.com/blueshamrockfarm/">
                            ...
                            <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/blue.shamrock.farm/">
                                <svg viewBox="0 0 28 28" width="35" height="35" fill="#fff">
                                    <path
                            ...
                            <a target="_blank" rel="noopener noreferrer"
                                href="https://www.tiktok.com/@blueshamrockfarm">
                                <svg viewBox="0 0 28 28" width="35" height="35" fill="#fff">
                            ...
                            <a target="_blank" rel="noopener noreferrer"
                                ...
                                <svg viewBox="0 0 52 52" width="35" height="35" fill="#fff">
                                    <path
                ...
                <ul>
                    ...
                    <li><a href="" className="no-underline">Forms</a></li>
                    <li><a href="/services" className="no-underline">All Services</a></li>
                    <li><a href="/privacy-policy" className="no-underline">Privacy Policy</a></li>
                    <li>
